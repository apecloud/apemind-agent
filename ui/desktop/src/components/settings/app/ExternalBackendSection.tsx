...
const i18n = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      'By default ApeMind Agent starts a local backend. Use this to connect to an external ACP-compatible backend.',
  },
  useExternalServer: {
  ...
  useExternalServerDescription: {
    ...
    defaultMessage: 'Connect to an ACP-compatible ApeMind Agent backend running elsewhere.',
  },
  serverUrl: {
  ...
  serverUrlHelp: {
    ...
    defaultMessage:
      'Enter the HTTP(S) base URL. ApeMind Agent checks /status and connects to /acp under this base.',
  },
  secretKey: {
  ...
  restartNote: {
    ...
    defaultMessage:
      'Changes apply to new chat windows. Restart ApeMind Agent to update existing windows.',
  },
  urlProtocolError: {
